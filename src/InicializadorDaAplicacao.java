...
public class InicializadorDaAplicacao
{
  ...
  {   
    ...
    try{
      java.io.InputStream ins = InicializadorDaAplicacao.class.getClassLoader().getResourceAsStream("run_configuration");
      if (ins == null ) {
  ...
  public static URL getResource(String path) {
      return InicializadorDaAplicacao.class.getClassLoader().getResource(path);
  }
